...
app.controller("BarCtrl", function ($scope, $http) {
  $scope.labels = ['Virgin America', 'United Air Lines Inc.', 'US Airways Inc.', 'Frontier Airlines Inc.', 'JetBlue Airways',
   'Skywest Airlines Inc.', 'Alaska Airlines Inc.', 'Spirit Air Lines', 'Southwest Airlines Co.', 'Delta Air Lines Inc.',
   'Atlantic Southeast Airlines', 'Hawaiian Airlines Inc.', 'American Eagle Airlines Inc.'];

  $scope.series1 = ['min_delay'];
  $scope.series1 = ['max_delay'];
